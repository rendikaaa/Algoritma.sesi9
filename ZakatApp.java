...
public class ZakatApp {
    Console console;
    LinkedList<Zakat> dataZakat;
    LinkedList<Sedekah> dataSedekah;

    public ZakatApp(){
        this.console = System.console();
        this.dataZakat = new LinkedList<>();
        this.dataSedekah = new LinkedList<>();
    }
    public void run() {
        while(true){
            ...
            switch(menu){
                ...
                case 3:
                    ...
                    console.readLine("Tekan enter untuk kembali!");
                    break;
                default:
